...
def abrir_dolar(frame_atual, janela):
    ...
    titulo = ctk.CTkLabel(frame, text='Cotação atual do Dolar', font=('Arial', 20))
    ...
    price = ctk.CTkLabel(frame, text='', font=('Helvetica', 15), bg_color='#28881F')
    ...
    def pesquisar_dolar():
        ...
        if dolar == None:
            ...
            price.configure(text=f'O preço do dolar atualmente convertendo para real esta em  R${dolar}')
    ...
    def calcular():
        ...
        if dolar != None:
            ...
            ret.configure(text=f'Seus dolares convertidos para reais são iguais a {int(res)}R$')
        else:
